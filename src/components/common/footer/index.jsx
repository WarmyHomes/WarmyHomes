				...
				<div className="row g-4">
					<div className="col-lg-4">
						...
						<div className="d-flex">
                            <button className="btn btn-primary btn-lg mb-2 me-3">App Store <FaAppStore /></button>
                            <button className="btn btn-primary btn-lg mb-2 ">Google Play <FaGooglePlay /></button>
                        </div>
					</div>
